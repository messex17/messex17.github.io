				...
				<!-- Intro -->
					<section class="intro">
						<header>
							...
							<p>Operations Research and Engineering <br/> Systems Engineering</p>
							<ul class="actions">
...
print 'Sorted in ' + i + ' iterations.';</code></pre>
				...
				<!-- Copyright -->
					<div class="copyright">&copy; Mary Essex.</div>
					<!-- <div class="copyright">&copy; Mary Essex. All rights reserved. Design: <a href="https://html5up.net">HTML5 UP</a>.</div> -->
